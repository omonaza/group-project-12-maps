...
public class MergeMapsTest {
    ...
    public void mergeTest1() {
        ...
        assertEquals("All values from first needs to be exist", expected, mergedWithSecond);
    }
    ...
    public void mergeTest2() {
        ...
        assertNotEquals("All values from second needs to be exist", expected, mergedWithSecond);
    }
}
